...
<main role="main" class="bg-grey">
      ...
      <!-- Header -->
      <header class="header-primary header-glossary d-flex align-items-center justify-content-center">
      ...
      <section class="container pt-5 px-0 bg-grey">
        ...
        <div class="list-group-flush d-flex flex-wrap glossary-links mt-5 w-100 justify-content-center bg-grey border-bottom">
          ...
          <a class="list-group-item glossary" href="#b">B</a>
          <a class="list-group-item glossary" href="#c">C</a>
          <a class="list-group-item glossary" href="#d">D</a>
          <a class="list-group-item glossary" href="#e">E</a>
          <a class="list-group-item glossary" href="#f">F</a>
          <a class="list-group-item glossary" href="#g">G</a>
          <a class="list-group-item glossary" href="#h">H</a>
          <a class="list-group-item glossary" href="#i">I</a>
          <a class="list-group-item glossary">J</a>
          <a class="list-group-item glossary">K</a>
          <a class="list-group-item glossary" href="#l">L</a>
          <a class="list-group-item glossary" href="#m">M</a>
          ...
          <a class="list-group-item glossary" href="#u">U</a>
          <a class="list-group-item glossary" href="#v">V</a>
          <a class="list-group-item glossary">W</a>
          <a class="list-group-item glossary">X</a>
          <a class="list-group-item glossary" href="#y">Y</a>
          <a class="list-group-item glossary">Z</a>
        </div>
          <section class="container">
            <section id="a" class="scroll-pad-gloss">
              <h3 class="pt-4">
                Accredited Investor
              </h3>
            ...
            <section id="b" class="scroll-pad-gloss">
              <h3 class="pt-4">Basis Point</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
                A basis point (bps) is equal to 1/100th of 1% or .01% and is a common unit of measure for interest rate changes.
              </p>
            </section>
            <section id="c" class="scroll-pad-gloss">
              <h3 class="pt-4">Capital Gains Taxes</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Capital Stack</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Capitalization (Cap) Rate</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="d" class="scroll-pad-gloss">
              <h3 class="pt-4">Depreciation Recapture</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Distribution Waterfall</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
                A distribution waterfall is the order in which an investment vehicle makes payment distributions.
                </p>
            </section>
            <section id="e" class="scroll-pad-gloss">
              <h3 class="pt-4">Equity</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="f" class="scroll-pad-gloss">
              <h3 class="pt-4">Free Cash Flow (FCF)</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="g" class="scroll-pad-gloss">
              <h3 class="pt-4">GP Investor</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="i" class="scroll-pad-gloss">
              ...
              <h3 class="pt-4">Internal Rate of Return (IRR) </h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="l" class="scroll-pad-gloss">
              <h3 class="pt-4">Limited Partner (LP) Investor</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="m" class="scroll-pad-gloss">
              <h3 class="pt-4">Mezzanine Debt</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Modern Portfolio Theory</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Multifamily Real Estate</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="n" class="scroll-pad-gloss">
              <h3 class="pt-4">Net Operating Income (NOI)</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Net Present Value</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="o" class="scroll-pad-gloss">
              ...
              <h3 class="pt-4">Opportunity Zone</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="p" class="scroll-pad-gloss">
              <h3 class="pt-4">Preferred Return</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Private-Market Real Estate</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="r" class="scroll-pad-gloss">
              <h3 class="pt-4">Real Estate Investment Trust (REIT)</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Regulation D (“Reg D”)</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="s" class="scroll-pad-gloss">
              <h3 class="pt-4">Sales Comps</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
              ...
              <h3 class="pt-4">Secondary Markets</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="t" class="scroll-pad-gloss">
              <h3 class="pt-4">Triple Net Lease</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="u" class="scroll-pad-gloss">
              <h3 class="pt-4">Underwriting</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
            ...
            <section id="v" class="scroll-pad-gloss">
              <h3 class="pt-4">Value Add</h3>
              <div class="separator-gradient mb-3"></div>
              <p>
