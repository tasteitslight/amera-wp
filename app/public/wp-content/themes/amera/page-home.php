...
<main role="main">
      ...
      <section id="video" class="container-fluid bg-grey border-top py-5">
        ...
        <iframe id="video-iframe" src="https://www.youtube.com/embed/QKuQrAxHMoc?rel=0&modestbranding=1&autohide=1&fs=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      ...
      <section class="container text-center">
        ...
        <p class="mb-5 pb-5">
          Amounts shown are after-tax profits of $1,000,000 invested for 10 years in a traditional stock portfolio with 9% simple appreciation versus that invested in an Opportunity Fund with 9% simple appreciation. For illustrative purposes only. Learn more about the <a href="/tax-advantage">Tax Benefits of Opportunity Funds.</a>
        </p>
      </section>
