...
<main class="bg-grey" role="main">
      ...
      <div class="separator-gradient mb-3"></div>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to American Group LLC, 1109 Westwood Blvd.</p>
            ...
            <li><strong>Website</strong> refers to American Group - Commercial Real Estate, accessible from https//americangroup.us</li>        <li><strong>Service</strong> refers to the Website.</li>
            ...
            <li><strong>Facebook Fan Page</strong> is a public profile named American Group - Commercial Real Estate specifically created by the Company on the Facebook social network, accessible from https://www.facebook.com/americangroupre</li>    <li>
        ...
        <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page (https://www.facebook.com/americangroupre), the Company and the operator of the social network Facebook are Joint Controllers.</p>
        ...
        <ul>
            <li>By email: support@americangroup.us</li>
            <li>By phone number: 8889454242</li>
        </ul>
      </section>
    </main>
