      ...
      <div class="container footer-container">
        <div class="row">
          <div class="col-12 col-lg text-center">
            <img class="pt-0 pb-5" src="<?php bloginfo('template_directory'); ?>/assets/img/logo/logo-placeholder.png" width="150px"/>
          </div>
          <div class="col-6 col-md-3 col-lg">
            <h6>Why Placeholder?</h6>
            <ul class="footer-ul">
          ...
          <div class="col-6 col-md-3 col-lg">
            <h6>Opportunity Fund</h6>
            <ul class="footer-ul">
              <li><a href="/opportunity-fund">General Info</a></li>
              <li><a href="/tax-advantage">Tax Advantages</a></li>
              <li><a href="/1031-exchange">1031 vs QOZ Fund</a></li>
      ...
      <div class="container text-center footer-email">
        <div class="row">
          <div class="col-12 col-md-7 pb-3 pb-sm-0">
            ...
            <a href="mailto:investments@placeholder.com" >investments@placeholder.com</a>
          </div>
