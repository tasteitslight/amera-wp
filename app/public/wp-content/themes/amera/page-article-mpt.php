...
<main role="main">
      ...
      <header class="header-primary header-article-2 d-flex align-items-center justify-content-center">
        <div class="container text-left">
          ...
          <h6 class="font-source">
            American Group Staff, October 1, 2019
          </h6> 
        </div>
      ...
      <section class="container position-relative my-5">  
        <div class="row">
          ...
          <div class="col-12 col-md-8">
            ...
            <p>
              <strong>Return:</strong> The profit you make on an investment is the return. It could be capital gains from: 
            </p>
            <ul>
              <li>
                Stocks
            ...
            <p>
              <strong>Risk:</strong> The chance you take that a particular investment will not provide the desired return. In general, stocks have a higher risk level than bonds, but every investment carries some type of risk. Risk can also refer to “volatility,” or the amount an asset’s value rises and falls with market fluctuations.
            </p>
            <h5>
