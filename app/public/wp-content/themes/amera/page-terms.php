...
<main class="bg-grey" role="main">
      ...
      <section class="container pt-5 bg-grey">
        ...
        <p>
          The decision to do business with American Group and our affiliates electronically is yours. This document informs you of your rights concerning Disclosures. Because American Group operates only on the Internet, it is necessary for you to consent to transact business with us online and electronically.
        </p>
        <p>
          As part of doing business with American Group and our affiliates, you must also consent to our giving you certain disclosures electronically, either via our Site or to the e-mail address you provide to us.
        </p>
        <p>
          By agreeing to the Terms of Service, you agree to receive electronically all documents, communications, notices, contracts, and agreements, (including any IRS Forms, IRS Form 1099, Form K-1) or other tax forms, schedules or information statements, arising from or relating to your registration as an investor on our Site, any investments you may make, your use of this service, and the servicing of any investment and any notes you have purchased (each, a “Disclosure”), as either an investor of American Group, whether we are acting in the capacity as trustee or otherwise, or our affiliates.
        </p>
        <p>
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          Your consent to receive disclosures and transact business electronically, and our agreements to do so, applies to any transactions to which such disclosures relate, whether between you and American Group or between you and our affiliates. Your consent will remain in effect for so long as you are a user and, if you are no longer a user, will continue until such a time as all disclosures relevant to transactions that occurred while you were a user have been made.
        </p>
        <h4 class="pt-4">
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          American Group generally receives all payments, and makes all disbursements, through electronic funds transfers (ACH transfers) using the bank (or other financial institution) account information you provide to us. You authorize such bank or other financial account to pay any amounts described herein, and authorize American Group to make any and all investment disbursements, to such account. You agree to provide American Group updated information regarding your bank or other account upon American Group’s request and at any time that the information earlier provided is no longer valid.
        </p>
        <h4 class="pt-4">
          Withdrawing Consent
        </h4>
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          If the personal information on file for you changes, or if you no longer desire our service, you may correct or update it by making the change on our customer information page or by emailing American Group Customer Service.
        </p>
        <p>
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          You herein acknowledge, understand and agree that all of the American Group trademarks, copyright, trade name, service marks, and other American Group logos and any brand features, and/or product and service names are trademarks and as such, are and shall remain the property of American Group. You herein agree not to display and/or use in any manner the American Group logo or marks.
        </p>
        <h4 class="pt-4">
          Entire Agreement
        </h4>
        <div class="separator-gradient mb-3"></div>
        <p>
          This Terms of Use constitutes the entire agreement between you and American Group and shall govern the use of our Services, superseding any prior version of this Terms of Use between you and us with respect to American Group Services. You may also be subject to additional terms and conditions that may apply when you use or purchase certain other American Group Services, affiliate Services, third-party content or third-party software.
        </p>
        <h4 class="pt-4">
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          It is at the mutual agreement of both you and American Group with regard to the Terms of Use that the relationship between the parties shall be governed by the laws of the state of California without regard to its conflict of law provisions and that any and all claims, causes of action and/or disputes, arising out of or relating to the Terms of Use, or the relationship between you and American Group, shall be filed within the courts having jurisdiction within the County of San Diego, California or the U.S. District Court located in said state. You and American Group agree to submit to the jurisdiction of the courts as previously mentioned, and agree to waive any and all objections to the exercise of jurisdiction over the parties by such courts and to venue in such courts.
        </p>
        <h4 class="pt-4">
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          At any time, should American Group fail to exercise or enforce any right or provision of the Terms of Use, such failure shall not constitute a waiver of such right or provision. If any provision of this Terms of Use is found by a court of competent jurisdiction to be invalid, the parties nevertheless agree that the court should endeavor to give effect to the parties’ intentions as reflected in the provision, and the other provisions of the Terms of Use remain in full force and effect.
        </p>
        <h4 class="pt-4">
        ...
        <div class="separator-gradient mb-3"></div>
        <p>
          Please report any and all violations of this Terms of Use to American Group as follows:
        </p>
        <p class="pb-5">
          Mailing Address:
          <br/>
